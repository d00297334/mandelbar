...
//M AND J DELETE COMPLEX FRACTAL AND REMAKE
//when you use complex fractal it is a pointer and not a reference
...
int main(int argc, char **argv){
    ...
    int c;
    while((c = getopt ( argc, argv, "T:A:R:g:MJr:p:m:a:h?f:B")) != -1 ){
        switch(c) {
